          ...
          <div className="flex-1">
            ...
            <div className="bg-white p-6 rounded-b-lg shadow-sm">
              ...
              <p className="text-gray-700 mb-4">
                ...
                advocacy movement by supporting promising projects around the
                world. Grants will be determined by review committee. Thank you!
              </p>
          ...
          <div className="flex-1">
            ...
            <div className="mt-10 bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-6">
                With Fluffy&apos;s, you are working to save the lives of cats
                and dogs, many other animals all across world, giving pets
                second chances and happy homes and new family.
              </p>
